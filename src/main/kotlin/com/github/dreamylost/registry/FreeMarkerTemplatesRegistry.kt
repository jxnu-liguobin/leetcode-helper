...
object FreeMarkerTemplatesRegistry {
    ...
    private val FREEMARKER_TEMPLATE_VERSION: freemarker.template.Version =
        Configuration.VERSION_2_3_30
    private val templateMap = EnumMap<GeneratedLanguage, Template>(GeneratedLanguage::class.java)

    init {
        val configuration = getConfiguration()
        configuration.setClassLoaderForTemplateLoading(LeetcodeGradlePlugin::class.java.classLoader, "")
        templateMap[GeneratedLanguage.Kotlin] =
            configuration.getTemplate("templates/KotlinTemplate.ftl")
